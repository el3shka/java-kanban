...
class TaskManagerTest {
    ...
    public void shouldCrossing() {
        ...
        Task crossTask = new Task("Task1", "Тест", LocalDateTime.now(), Duration.ofHours(1));
        assertThrows(CrossingTaskException.class, () -> taskManager.createTask(crossTask), "Таски пересекаются");

        Subtask crossSubtask = new Subtask("Подзадача", "Test", 1,
        ...
        Subtask notCrossSubtask = new Subtask("Подзадача", "Test", 1,
